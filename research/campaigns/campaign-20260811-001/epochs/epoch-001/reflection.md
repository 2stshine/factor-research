# campaign-20260811-001 / epoch-001 성찰
...
|---|---|---|---|---|
| `intermediate_momentum_12_7` | `intermediate_momentum` | NO_PREDICTIVE_EVIDENCE | RELATED | `research/runs/cycle-0052-intermediate_momentum_12_7/report.md` |
| `market_leverage` | `market_leverage` | DISCOVERY_FDR_PENDING | DUPLICATE | `research/runs/cycle-0053-market_leverage/report.md` |
