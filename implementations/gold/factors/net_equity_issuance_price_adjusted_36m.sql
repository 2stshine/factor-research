-- net_equity_issuance_price_adjusted_36m Gold implementation.
-- value = (시가총액 / 분할조정 가격)의 정확한 36개월 증가율
...
WITH certified AS (
    ...
    WHERE signal_month
      ...
      AND signal_month = prior_signal_month + INTERVAL '36 months'
), ranked AS (
    SELECT
