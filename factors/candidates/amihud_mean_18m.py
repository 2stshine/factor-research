...
FACTOR = Factor(
    name='amihud_mean_18m',
    family='amihud_mean_18m',
    category='other',
    exploration_domain='liquidity_trading',
    hypothesis='최근 18개월 Amihud 가격충격 비유동성의 mean가 높은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
    predicted_sign=1,
    params={'window_months': WINDOW_MONTHS, 'min_observations': MIN_OBSERVATIONS, 'source': 'amihud', 'reducer': 'mean'},
    rebalance_months=1,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 18개월 Amihud 가격충격 비유동성의 mean가 높은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
