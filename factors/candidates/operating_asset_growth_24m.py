...
FACTOR = Factor(
    name='operating_asset_growth_24m',
    family='operating_asset_growth_24m',
    category='quality',
    exploration_domain='investment_capital_allocation',
    hypothesis='최근 24개월 영업자산 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 24개월 영업자산 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
