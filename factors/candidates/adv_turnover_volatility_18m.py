...
FACTOR = Factor(
    name='adv_turnover_volatility_18m',
    family='adv_turnover_volatility_18m',
    category='other',
    exploration_domain='liquidity_trading',
    hypothesis='최근 18개월 ADV20/시가총액 거래회전의 std가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
    predicted_sign=-1,
    params={'window_months': WINDOW_MONTHS, 'min_observations': MIN_OBSERVATIONS, 'source': 'adv_turnover', 'reducer': 'std'},
    rebalance_months=1,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 18개월 ADV20/시가총액 거래회전의 std가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
