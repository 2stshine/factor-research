...
FACTOR = Factor(
    name='market_relative_momentum_6_1',
    family='market_relative_momentum_6_1',
    category='momentum',
    exploration_domain='momentum_trend_reversal',
    hypothesis='시장 공통 추세를 뺀 6-1개월 종목 고유 모멘텀이 높은 종목의 이후 상대수익이 높다.',
    predicted_sign=1,
...
RESEARCH_SPEC = {
    "thesis": '시장 공통 추세를 뺀 6-1개월 종목 고유 모멘텀이 높은 종목의 이후 상대수익이 높다.',
