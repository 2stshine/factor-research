...
FACTOR = Factor(
    name='realized_daily_volatility_instability_36m',
    family='realized_daily_volatility_instability_36m',
    category='quality',
    exploration_domain='low_risk',
    hypothesis='최근 36개월 daily_volatility_252d의 std가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
    params={'window_months': WINDOW_MONTHS, 'min_observations': MIN_OBSERVATIONS, 'source_field': 'daily_volatility_252d', 'reducer': 'std'},
    rebalance_months=1,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 36개월 daily_volatility_252d의 std가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
