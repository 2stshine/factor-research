...
FACTOR = Factor(
    name='adv_turnover_mean_24m',
    family='adv_turnover_mean_24m',
    category='other',
    exploration_domain='liquidity_trading',
    hypothesis='최근 24개월 ADV20/시가총액 거래회전의 mean가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 24개월 ADV20/시가총액 거래회전의 mean가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
