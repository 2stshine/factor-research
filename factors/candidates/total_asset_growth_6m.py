...
FACTOR = Factor(
    name='total_asset_growth_6m',
    family='total_asset_growth_6m',
    category='quality',
    exploration_domain='investment_capital_allocation',
    hypothesis='최근 6개월 total_assets 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 total_assets 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
