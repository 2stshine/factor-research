...
FACTOR = Factor(
    name='max_daily_return_mean_6m',
    family='max_daily_return_mean_6m',
    category='quality',
    exploration_domain='low_risk',
    hypothesis='최근 6개월 max_daily_return_1m의 mean가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
    params={'window_months': WINDOW_MONTHS, 'min_observations': MIN_OBSERVATIONS, 'source_field': 'max_daily_return_1m', 'reducer': 'mean'},
    rebalance_months=1,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 max_daily_return_1m의 mean가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
