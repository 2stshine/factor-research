...
FACTOR = Factor(
    name='market_return_correlation_24m',
    family='market_return_correlation_24m',
    category='quality',
    exploration_domain='low_risk',
    hypothesis='최근 24개월 correlation가 낮은 종목은 고위험 선호에 따른 과대가격을 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
    params={'window_months': WINDOW_MONTHS, 'min_observations': MIN_OBSERVATIONS, 'risk_measure': 'correlation', 'benchmark': 'lagged_market_cap_weighted'},
    rebalance_months=1,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 24개월 correlation가 낮은 종목은 고위험 선호에 따른 과대가격을 피하여 이후 상대수익이 높다.',
