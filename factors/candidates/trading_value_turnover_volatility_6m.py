...
FACTOR = Factor(
    name='trading_value_turnover_volatility_6m',
    family='trading_value_turnover_volatility_6m',
    category='other',
    exploration_domain='liquidity_trading',
    hypothesis='최근 6개월 월말 거래대금/시가총액 활동의 std가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 월말 거래대금/시가총액 활동의 std가 낮은 종목은 유동성 보상 또는 과도한 관심 교정으로 이후 상대수익이 높다.',
