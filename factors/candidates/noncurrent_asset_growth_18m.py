...
FACTOR = Factor(
    name='noncurrent_asset_growth_18m',
    family='noncurrent_asset_growth_18m',
    category='quality',
    exploration_domain='investment_capital_allocation',
    hypothesis='최근 18개월 noncurrent_assets 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 18개월 noncurrent_assets 증가율이 낮은 기업은 과잉투자·자산팽창 위험이 작아 이후 상대수익이 높다.',
