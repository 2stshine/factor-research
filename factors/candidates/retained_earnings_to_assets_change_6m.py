...
FACTOR = Factor(
    name='retained_earnings_to_assets_change_6m',
    family='retained_earnings_to_assets_change_6m',
    category='earnings',
    exploration_domain='profitability_quality',
    hypothesis='최근 6개월 retained_earnings/total_assets 개선이 큰 기업은 이익의 질과 지속성이 높아 이후 상대수익이 높다.',
    predicted_sign=1,
    params={'lookback_months': LOOKBACK_MONTHS, 'numerator': 'retained_earnings', 'denominator': 'total_assets'},
    rebalance_months=3,
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 retained_earnings/total_assets 개선이 큰 기업은 이익의 질과 지속성이 높아 이후 상대수익이 높다.',
