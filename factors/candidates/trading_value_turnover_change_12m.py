...
FACTOR = Factor(
    name='trading_value_turnover_change_12m',
    family='trading_value_turnover_change_12m',
    category='other',
    exploration_domain='liquidity_trading',
    hypothesis='최근 12개월 trading_value_turnover 급증이 작은 종목은 과도한 관심과 투기수요를 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 12개월 trading_value_turnover 급증이 작은 종목은 과도한 관심과 투기수요를 피하여 이후 상대수익이 높다.',
