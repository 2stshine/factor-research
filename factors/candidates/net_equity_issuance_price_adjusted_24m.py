...
FACTOR = Factor(
    name='net_equity_issuance_price_adjusted_24m',
    family='net_equity_issuance_price_adjusted_24m',
    category='other',
    exploration_domain='financing_issuance',
    hypothesis='최근 24개월 price_adjusted_issuance 확대가 큰 기업은 외부자금 수요나 고평가 활용 가능성이 높아 이후 상대수익이 낮다.',
    predicted_sign=-1,
    params={'lookback_months': LOOKBACK_MONTHS, 'financing_measure': 'price_adjusted_issuance'},
    rebalance_months=3,
    needs=(),
    compute=compute,
)
...
RESEARCH_SPEC = {
    "thesis": '최근 24개월 price_adjusted_issuance 확대가 큰 기업은 외부자금 수요나 고평가 활용 가능성이 높아 이후 상대수익이 낮다.',
