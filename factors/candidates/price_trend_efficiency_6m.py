...
FACTOR = Factor(
    name='price_trend_efficiency_6m',
    family='price_trend_efficiency_6m',
    category='momentum',
    exploration_domain='momentum_trend_reversal',
    hypothesis='6개월 가격경로 대비 방향효율이 높은 추세는 이후에도 지속된다.',
    predicted_sign=1,
...
RESEARCH_SPEC = {
    "thesis": '6개월 가격경로 대비 방향효율이 높은 추세는 이후에도 지속된다.',
    "mechanism": '왕복 잡음이 적은 단기 추세를 분리한다.',
    "falsification": (
    ...
    "data_notes": 'adj_close의 연속 6개월 경로만 사용한다.',
}
