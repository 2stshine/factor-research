...
FACTOR = Factor(
    name='realized_daily_volatility_instability_6m',
    family='realized_daily_volatility_instability_6m',
    category='quality',
    exploration_domain='low_risk',
    hypothesis='최근 6개월 daily_volatility_252d의 std가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 daily_volatility_252d의 std가 낮은 종목은 복권형 수요와 위험추종 수요의 과대가격을 피하여 이후 상대수익이 높다.',
