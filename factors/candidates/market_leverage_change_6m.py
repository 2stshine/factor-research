...
FACTOR = Factor(
    name='market_leverage_change_6m',
    family='market_leverage_change_6m',
    category='other',
    exploration_domain='financing_issuance',
    hypothesis='최근 6개월 market_leverage 확대가 큰 기업은 외부자금 수요나 고평가 활용 가능성이 높아 이후 상대수익이 낮다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 6개월 market_leverage 확대가 큰 기업은 외부자금 수요나 고평가 활용 가능성이 높아 이후 상대수익이 낮다.',
