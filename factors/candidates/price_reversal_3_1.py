...
FACTOR = Factor(
    name='price_reversal_3_1',
    family='price_reversal_3_1',
    category='momentum',
    exploration_domain='momentum_trend_reversal',
    hypothesis='분할조정 가격의 3개월 전 대비 1개월 전 수익률이 낮은 종목은 정보의 지연반영 또는 장기 과잉반응 교정으로 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '분할조정 가격의 3개월 전 대비 1개월 전 수익률이 낮은 종목은 정보의 지연반영 또는 장기 과잉반응 교정으로 이후 상대수익이 높다.',
