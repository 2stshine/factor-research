...
FACTOR = Factor(
    name='pretax_yield_change_12m',
    family='pretax_yield_change_12m',
    category='value',
    exploration_domain='value',
    hypothesis='pretax_income_ttm 대비 시장가치의 12개월 개선이 큰 기업은 펀더멘털 대비 가격이 덜 반영되어 이후 상대수익이 높다.',
    predicted_sign=1,
...
RESEARCH_SPEC = {
    "thesis": 'pretax_income_ttm 대비 시장가치의 12개월 개선이 큰 기업은 펀더멘털 대비 가격이 덜 반영되어 이후 상대수익이 높다.',
