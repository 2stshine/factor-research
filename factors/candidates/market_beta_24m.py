...
FACTOR = Factor(
    name='market_beta_24m',
    family='market_beta_24m',
    category='quality',
    exploration_domain='low_risk',
    hypothesis='최근 24개월 beta가 낮은 종목은 고위험 선호에 따른 과대가격을 피하여 이후 상대수익이 높다.',
    predicted_sign=-1,
...
RESEARCH_SPEC = {
    "thesis": '최근 24개월 beta가 낮은 종목은 고위험 선호에 따른 과대가격을 피하여 이후 상대수익이 높다.',
