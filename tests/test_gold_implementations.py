...
EXPECTED_DEFINITIONS = {
    ...
    "book_to_market_change_6m": (1, "13d7e8d539ebcf9a"),
    "capital_stock_growth_12m": (-1, "e09f61de6fa86d70"),
    "capital_stock_growth_18m": (-1, "4f5fb784acc782f3"),
    ...
    "enterprise_sales_yield_change_6m": (1, "7db27be88ae7fe84"),
    ...
    "pretax_yield_change_6m": (1, "ffea4912dd9bcb98"),
    "price_range_12m": (-1, "b564b360f33b0dca"),
    "realized_volatility_252d": (-1, "e0668fb0e7c0eb69"),
    "realized_daily_volatility_change_24m": (-1, "ac577decfdf6edbd"),
    "realized_daily_volatility_instability_6m": (-1, "33050a6c1055cb3e"),
